...
function artifactName(path) {
  return typeof path === "string" && path.length > 0 ? (0, import_node_path2.basename)(path) : void 0;
}
...
var WorkflowCatalog = class _WorkflowCatalog {
  ...
  static async load(workflowsDir2, configDir) {
    ...
    for (const filename of await (0, import_promises2.readdir)(workflowsDir2)) {
      ...
      const file = workflowFileSchema.parse(
        JSON.parse(await (0, import_promises2.readFile)((0, import_node_path3.join)(workflowsDir2, filename), "utf8"))
      );
...
var TaskStateStore = class {
  ...
  file;
  constructor(taskDir) {
    this.engineDir = (0, import_node_path4.join)(taskDir, ".engine");
    this.file = (0, import_node_path4.join)(this.engineDir, "_state.json");
  }
  async exists() {
    try {
      await (0, import_promises3.access)(this.file);
      return true;
    } catch {
      return false;
    }
  ...
  async read() {
    return JSON.parse(await (0, import_promises3.readFile)(this.file, "utf8"));
  }
  /** Atomic: temp file then rename, so an interrupted write cannot corrupt the task. */
  async write(state) {
    await (0, import_promises3.mkdir)(this.engineDir, { recursive: true });
    const tmp = `${this.file}.tmp`;
    await (0, import_promises3.writeFile)(tmp, JSON.stringify(state, null, 2), "utf8");
    await (0, import_promises3.rename)(tmp, this.file);
  }
};

// src/workspace/TaskWorkspace.ts
...
var TaskWorkspace = class _TaskWorkspace {
  ...
  async snapshotJson() {
    return (0, import_promises4.readFile)((0, import_node_path5.join)(this.dir, ".engine", "workflow.json"), "utf8");
  }
  ...
  async writeWorkspaceFile(repos) {
    const file = (0, import_node_path5.join)(this.dir, `${this.taskId}.code-workspace`);
    const content = {
      folders: [...repos, { name: this.taskId, path: this.dir }],
      settings: { "aiDevWorkflow.taskId": this.taskId }
    };
    await (0, import_promises4.writeFile)(file, JSON.stringify(content, null, 2), "utf8");
    return file;
  }
};
...
// src/tasks/CopilotEditingHandoff.ts
...
// src/tasks/InvokeCopilotCoding.ts
...
// src/tasks/InvokeCopilotCodeReview.ts
