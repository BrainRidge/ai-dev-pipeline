...
export type { Mechanism } from '../handoff/Handoff'
import type { Mechanism } from '../handoff/Handoff'
 ...
 * three lines long.
 */
export function summariseHandoffs(perTask: AuditEntry[][]): HandoffSummary {
