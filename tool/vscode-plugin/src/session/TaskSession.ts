...
import { AuditLog } from '@ai-dev-pipeline/core'
import { WebviewBridge } from '@ai-dev-pipeline/core'
import { panelHtml, vscodeTransport } from '../bridge/vscodeTransport'
import { VsCodeHost } from '../host/VsCodeHost'
import { buildWorkflowDescriptor } from '@ai-dev-pipeline/core'
import { buildWorkflow, WorkflowCatalog } from '@ai-dev-pipeline/core'
import { WorkflowEngine } from '@ai-dev-pipeline/core'
...
import { allInsideOpenFolders } from '@ai-dev-pipeline/core'
import { resolveCodeRoot, resolveTasksRoot } from '@ai-dev-pipeline/core'
import {
  isAbsolutePath,
  needsFeatureStory,
  normaliseSetup,
...
import type { CommandMode, CommandPlanner } from '@ai-dev-pipeline/core'
import { reposBefore } from '@ai-dev-pipeline/core'
import type { CopilotHandoff } from '@ai-dev-pipeline/core'
import { editedPrompt } from '@ai-dev-pipeline/core'
import type { ManualReview } from '@ai-dev-pipeline/core'
import type { ToolReporter } from '@ai-dev-pipeline/core'
import type { Mechanism } from '@ai-dev-pipeline/core'
import type { Answers, StepContext } from '@ai-dev-pipeline/core'
import type { TaskTypeRegistry } from '@ai-dev-pipeline/core'
