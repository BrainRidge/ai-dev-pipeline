...
import type { Handoff, Mechanism } from '@ai-dev-pipeline/core'
 ...
 *
 * This is the VS Code rung ladder specifically. The IntelliJ host has its own,
 * starting at B, because no third-party plugin can put text in Copilot Chat
 * there. See spec Section 19.
 */
