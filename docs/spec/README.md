...
Section 19 is design only, not yet implemented.
**Scope:** Phase 1 (see [Phasing](03-phasing.md)), plus Sections 16-19, which
post-date it
...
19. [Fetching an epic from the developer's own browser](19-epic-browser-fetch.md)
